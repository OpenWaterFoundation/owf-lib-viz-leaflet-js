...
$.ajax({
    ...
    success: function(json){
        ...
        for(var i = 0; i < (json.layers).length; i++){
            ...
            let layer_color = 'black';                  // color of outline
            ...
            let layer_fillColor = 'red';                // color of shape interior
            let layer_fillOpacity = 0.3;                // opacity of shape interior
            ...
            Check that the value given in the .json file is valid for the given field */
            ...
            /* leaflet 'radius' = map configuration file 'size' */
            ...
            */
            ...
            $.getJSON(json.layers[i].source,function(data){
                /* L.geoJSON creates a geoJSON layer. For more information on geoJSON layers
                go to: https://leafletjs.com/examples/geojson/ */
...
legend.onAdd = function (map) {
    ...
    if(singleSymbolKeyNames.length > 0){
        div.innerHTML += '<h4>Single Symbol Data:</h4>';
    ...
    if(categorizedKeyNames.length > 0){
        div.innerHTML += '<h4>Categorized Data:</h4>';
