...
$.ajax({
    url: "maps/polygon_layers_2019-05-15.json",
    async: false,
    dataType: 'json',
    ...
    success: function(json){
        ...
        for(var i = 0; i < (json.layers).length; i++){
            ...
            /** 
            * Used for color options. Options: singleSymbol -> use one color. graduated -> use colorTable. categorized -> use colorRamp 
            * @type {string}
            */
            let layer_classification = "singleSymbol";
            /** 
            * Used for the color table, describes which attribute determines the color of the point
            * @type {string}
            */
            let layer_classificationField = "";
            /** 
            ...
            */
            let layer_color = '';
            /** 
            * features will be shown in different shades based on values, (ex. Blues, Greens, Spectral...)
            * @type {string}
            */
            let layer_colorRamp = "";
            /** 
            * the largest value in the classificationField. Used to determine the range of the color ramp
            * @type {number}
            */
            let layer_colorRampMax = 100;
            /** 
            * the smallest value in the classificationField. Used to determine the range of the color ramp
            * @type {number}
            */
            let layer_colorRampMin = 0;
            /** 
            * list of colors and values associated with them ([value1, color, value2, color, value3, color...])
            * @type {string[]}
            */
            let layer_colorTable = [];
            /** 
            * dashed line (format example: '20, 10')
            * @type {string}
            */
            let layer_dashArray = null;
            /** 
            * fill color of the polygon
            * @type {string}
            */
            let layer_fillColor = 'blue';
            /** 
            * fill opacity of the polygon
            * @type {number}
            */
            let layer_fillOpacity = 0.1;
            /** 
            * shape to be used at the end of the stroke, either 'round' or 'square'
            * @type {string}
            */
            let layer_lineCap = 'round';
            /** 
            * shape to be used at the corners of the stroke, either 'round' or 'square'
            * @type {string}
            */
            let layer_lineJoin = 'round';
            /** 
            ...
            */
            ...
            /** 
            * if true popup is on mouseover. If false popup is on click
            * @type {string}
            */
            let layer_popupMouseover = 'false';
            /** 
            * name of property in geojson file to display in the popup
            * @type {string}
            */
            let layer_popupSource = "";
            /** 
            ...
            */
            ...
            $.getJSON(json.layers[i].source,function(data){
                ...
                let boundariesLayer = L.geoJSON(data, {style: setStyle, onEachFeature: popupInfo}).addTo(map);
            });
        }
    }
});
